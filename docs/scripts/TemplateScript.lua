...
function onMoveCamera(focus) --Called when the camera focuses to a character
...
-- Event notes hooks
function onEventCalled(name, value1, value2, flValue1, flValue2, strumTime)
	-- Event note triggered
	-- print('Event triggered: ', name, value1, value2, flValue1, flValue2, strumTime);
end
