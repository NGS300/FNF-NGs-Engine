function onCreate() {
    setVar("dirMods", function(path:String, ?libArray:Array<String>):String { // Mod Directory Versatile
    ...
    setVar("dirModsStages", function(path:String, ?libArray:Array<String>):String { // Mod Directory in Stages
