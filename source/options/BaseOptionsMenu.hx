...
class BaseOptionsMenu extends MusicBeatSubstate {
	...
	public function new() {
		...
		var titleText = new Alphabet(75, 45, title, true);
		...
		for (i in 0...optionsArray.length) {
			...
			if (optionsArray[i].type == BOOL) {
				var checkbox = new CheckboxThingie(optionText.x - 105, optionText.y, Std.string(optionsArray[i].getValue()) == "true");
				...
				//optionText.xAdd -= 80;
				var valueText = new AttachedText("" + optionsArray[i].getValue(), optionText.width + 60);
