    ...
    override function create() {
        ...
        for (i in 0...WeekData.weeksList.length) {
            ...
            if (!isLocked || !weekFile.hiddenUntilUnlocked) {
                ...
                // weekThing.loadGraphic(Paths.modsImages("storymenu/" + WeekData.weeksList[i]));
                // trace(weekFile);
                
                weekThing.pathAngle = 119.7;
                // weekThing.radius = 135.07; // distância percorrida por unidade de targetY (era a magnitude combinada)
                weekThing.startX = 80;
        ...
        /*var charArray:Array<String> = loadedWeeks[0].weekCharacters;
            ...
            var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07 + 100, bgSprite.y + 425).loadGraphic(Paths.image('$i/Menu_Tracks'));
