...
class DialogueEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent {
	...
	override function create() {
		...
		var addLineText = new FlxText(10, 10, FlxG.width - 20, "Press O to remove the current dialogue line, Press P to add another line after the current one.", 8);
	...
	function addDialogueLineUI() {
		...
		var loadButton = new PsychUIButton(20, lineInputText.y + 25, "Load Dialogue", function() loadDialogue());
		var saveButton = new PsychUIButton(loadButton.x + 120, loadButton.y, "Save Dialogue", function() saveDialogue());
	...
	static var DEFAULT_SPEED:Float = 0.05;
