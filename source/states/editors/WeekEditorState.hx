...
class WeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent {
	...
	function addEditorBox() {
		...
		var loadWeekButton = new PsychUIButton(0, 650, "Load Week", function() loadWeek());
		loadWeekButton.screenCenter(X);
		loadWeekButton.x -= 120;
		add(loadWeekButton);

		var freeplayButton = new PsychUIButton(0, 650, "Freeplay", function() MusicBeatState.switchState(new WeekEditorFreeplayState(weekFile)));
		freeplayButton.screenCenter(X);
		add(freeplayButton);

		var saveWeekButton = new PsychUIButton(0, 650, "Save Week", function() saveWeek(weekFile));
...
class WeekEditorFreeplayState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent {
	...
	override function create() {
		...
		for (i in 0...weekFile.songs.length) {
			var songText = new Alphabet(90, 320, weekFile.songs[i][0], true);
			...
			var icon = new HealthIcon(weekFile.songs[i][1]);
	...
	function addEditorBox() {
		...
		var blackBlack = new FlxSprite(0, 670).makeGraphic(FlxG.width, 50, FlxColor.BLACK);
		blackBlack.alpha = 0.6;
		add(blackBlack);

		var loadWeekButton = new PsychUIButton(0, 685, "Load Week", function() {
		...
		var storyModeButton = new PsychUIButton(0, 685, "Story Mode", function() {
			MusicBeatState.switchState(new WeekEditorState(weekFile));
		});
		storyModeButton.screenCenter(X);
		add(storyModeButton);

		var saveWeekButton = new PsychUIButton(0, 685, "Save Week", function() {
