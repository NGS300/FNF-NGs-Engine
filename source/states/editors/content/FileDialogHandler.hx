...
class FileDialogHandler extends FlxBasic { //Currently only supports OPEN and SAVE
...
class FileReferenceCustom extends FileReference { //Only way I could find to keep the path after saving a file
