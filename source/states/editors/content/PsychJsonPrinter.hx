...
class PsychJsonPrinter extends JsonPrinter {
	...
	override function fieldsString(v:Dynamic, fields:Array<String>) fieldsStringEx(v, fields);
		...
		for (i in 0...len) {
			...
			if (_mapCheck) {
				switch (Type.typeof(value)) {
					case TObject, TClass(Array), TClass(haxe.ds.StringMap): usedMapCheck = true;
