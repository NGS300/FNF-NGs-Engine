...
class DialogueCharacterEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent {
	...
	function addAnimationsUI() {
		...
		var addUpdateButton = new PsychUIButton(10, idleInputText.y + 30, "Add/Update", function() {
		...
		var removeUpdateButton = new PsychUIButton(100, addUpdateButton.y, "Remove", function() {
			for (i in 0...character.jsonFile.animations.length) {
				var animArray:DialogueAnimArray = character.jsonFile.animations[i];
	...
	function addCharacterUI() {
		...
		var noAntialiasingCheckbox = new PsychUICheckBox(scaleStepper.x + 80, scaleStepper.y, "No Antialiasing", 100);
		...
		var reloadImageButton = new PsychUIButton(10, scaleStepper.y + 60, "Reload Image", function() reloadCharacter());
		
		var loadButton = new PsychUIButton(reloadImageButton.x + 100, reloadImageButton.y, "Load Character", function() loadCharacter());

		var saveButton = new PsychUIButton(loadButton.x, reloadImageButton.y - 25, "Save Character", function() saveCharacter());
	...
	function reloadCharacter() {
		...
		#if DISCORD_ALLOWED DiscordClient.changePresence("Dialogue Character Editor", 'Editting: ${character.jsonFile.image}'); #end // Updating Discord Rich Presence
	}
