...
class MasterEditorMenu extends MusicBeatState {
	...
	override function create() {
		...
		#if DISCORD_ALLOWED DiscordClient.changePresence("Editors Main Menu", null); #end // Updating Discord Rich Presence
		...
		for (i in 0...options.length) {
			var leText = new Alphabet(90, 320, options[i], true);
		...
		#if MODS_ALLOWED
		var textBG = new FlxSprite(0, FlxG.height - 42).makeGraphic(FlxG.width, 42, 0xFF000000);
		textBG.alpha = 0.6;
		add(textBG);
