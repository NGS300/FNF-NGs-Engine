...
class RainShader extends FlxShader {
	...
	@:glFragmentSource("
		...
		vec2 worldToBackground(vec2 worldCoord) // this should work as long as the background sprite is placed at the origin without scaling
	...
	public function update(elapsed:Float):Void time += elapsed;
