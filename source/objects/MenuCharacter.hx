	...
	public function changeCharacter(?character:String = "bf") {
		...
		switch (character) {
			case "":
				...
				dontPlayAnim = true;
			default:
				var id = "menus/story/characters";
				var i = 'images/$id';
				var path:String = Paths.getPath('$i/$character.json', TEXT);
				#if MODS_ALLOWED
				...
				#end
				{
					var defaultPath:String = Paths.getPath('$i/$DEFAULT_CHARACTER.json', TEXT);
					#if MODS_ALLOWED
					...
					{
						path = defaultPath;
					} else { // If a character couldn't be found, change him to BF just to prevent a crash
				...
				frames = Paths.getSparrowAtlas('$id/${charFile.image}');
